...
var (
	...
	ErrMerchantHasBranches  = errors.New("MCH012: merchant has branches, cannot delete")
	ErrBranchHasStaff       = errors.New("MCH013: branch has staff members, cannot delete")
