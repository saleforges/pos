...
var (
	...
	ErrShiftNotFound               = errors.New("ORD015: shift not found")
	ErrInvalidShift                = errors.New("ORD016: invalid shift data")
	ErrShiftAlreadyOpen            = errors.New("ORD017: a shift is already open for this branch")
	ErrShiftAlreadyClosed          = errors.New("ORD018: shift is already closed")
