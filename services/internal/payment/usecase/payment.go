...
type PaymentUsecase interface {
	...
	ConfirmCash(ctx context.Context, params CreatePaymentParams) (*domain.PaymentTransaction, error)
	...
	GetStaticQR(ctx context.Context, merchantID, branchID int64) (*domain.StaticQR, error)
